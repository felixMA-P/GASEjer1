...
AGAS_Ejercicio1Character::AGAS_Ejercicio1Character()
{
...
void AGAS_Ejercicio1Character::Tick(float DeltaSeconds)
{
    Super::Tick(DeltaSeconds);
}

void AGAS_Ejercicio1Character::InitializeCharacter()
{
...
void AGAS_Ejercicio1Character::BeginPlay()
{
	Super::BeginPlay();
	InitializeCharacter();
}
